...
from app.api import application_loop, application_sprints, agents, autofill, contacts, copilot, email, health, jobs, llm, pipeline, queue, resume, tracker, webapp
...
app.include_router(application_sprints.router, prefix="/application-sprints", tags=["application-sprints"])
